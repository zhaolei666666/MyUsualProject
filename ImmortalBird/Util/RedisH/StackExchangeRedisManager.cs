...
namespace MyUtilLibrary.RedisH
{
    /// <summary>
    /// Redis操作
    /// </summary>
    public class StackExchangeRedisManager
    {
        ...
        public StackExchangeRedisManager(int dbNum = 0)
            : this(dbNum, null)
        {
        }

        public StackExchangeRedisManager(int dbNum, string readWriteHosts)
        {
            DbNum = dbNum;
            _conn =
                string.IsNullOrWhiteSpace(readWriteHosts) ?
                StackExchangeRedisConnection.Instance :
                StackExchangeRedisConnection.GetConnectionMultiplexer(readWriteHosts);
        }
        ...
        {
            var prefixKey = CustomKey ?? StackExchangeRedisConnection.SysCustomKey;
